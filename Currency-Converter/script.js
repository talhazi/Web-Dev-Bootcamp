...
const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=3469394f17589f36e5cb57365c7cc14c";

const initiallyDisplayedCurrencies = ["USD", "EUR", "ILS"];
let baseCurrency;
...
let currencies = [
  ...
  },
  {
    ...
    abbreviation: "ILS",
    symbol: "\u20AA",
    flagURL: "https://cdn.countryflags.com/thumbs/israel/flag-400.png"
  },
  {
    name: "Japanese Yen",
    abbreviation: "JPY",
